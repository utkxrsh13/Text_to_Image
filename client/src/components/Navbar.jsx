      ...
      <div>
        {user ?
          <div className='flex items-center gap-2 sm:gap-3'>
            <button className='flex items-center gap-2 bg-orange-300 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
              <i class=" text-xl ri-sparkling-fill"></i>
              <p className='text-xs sm:text-sm font-medium text-gray-700'>Credits Left:50</p>
            </button>
            <p className='text-gray-700 max-sm:hidden pl-4'>Name</p>
          ...
          <div className='flex items-center gap-2 sm:gap-5'>
            ...
            <button className='bg-zinc-800 text-white px-7 py-2 sm:px-10 text-sm rounded-lg'>Login</button>
          </div>}
      </div>
    </div>
  )
